  ...
  return (
    <Container>
      <Row className="d-flex justify-content-between">
        <Col sm={12} lg={6}>
          <h1 className="mt-4">
            <i className="backcolor badge text-color">Editar Categoria</i>
          </h1>
          <Form
          ...
          >
            ...
            <Form.Control.Feedback type="invalid" className="text-danger small">
              Campo obligatorio, al menos debe contener entre 6 - 15 caracteres.
            </Form.Control.Feedback>
            <Form.Group className="d-flex justify-content-end">
              <Button
                className="my-3 mx-2 text-dark"
                variant="warning"
                type="submit"
              >
                Editar
        ...
        <Col sm={12} lg={6}>
          ...
          <ListGroup className="my-3">
            {props.categorias.map((cat) => (
              <ListGroup.Item
                className="d-flex justify-content-between align-items-center border border-secondary"
                cat={cat}
                key={cat._id}
